...
const tipoConfig = {
  novo: { label: 'Novo', icon: Sparkles, color: 'bg-indigo-500/10 text-indigo-400 border-indigo-500/20' },
  melhoria: { label: 'Melhoria', icon: ArrowUpCircle, color: 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20' },
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-lg max-h-[90vh] flex flex-col rounded-3xl border border-white/10 bg-zinc-950 shadow-2xl shadow-black/50 overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          ...
          <div className="rounded-2xl border border-indigo-500/20 bg-indigo-500/5 p-5">
            <div className="flex items-center gap-2 mb-4">
              <span className="text-[10px] font-black bg-indigo-600 text-white px-2.5 py-1 rounded-full uppercase tracking-wider">
        ...
        <div className="px-6 py-4 border-t border-white/10 flex items-center justify-between">
          ...
          <button
            onClick={handleClose}
            className="px-5 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-bold rounded-xl transition-all active:scale-[0.97] shadow-lg shadow-indigo-600/20"
          >
            Entendido! 🚀
          </button>
        </div>
