  ...
  return (
    <PortalLayout user={user}>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <Button onClick={() => window.location.href = '/novo-pedido'}>
          Novo Pedido
        </Button>
      </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  ...
                  <th className="text-left text-xs font-medium text-slate-500 uppercase tracking-wider px-6 py-4">Entrega</th>
                  <th className="text-right text-xs font-medium text-slate-500 uppercase tracking-wider px-6 py-4">Valor</th>
                  <th className="text-right text-xs font-medium text-slate-500 uppercase tracking-wider px-6 py-4">Ações</th>
                </tr>
              </thead>
                  ...
                  filteredPedidos.map((pedido) => (
                    <tr key={pedido.id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        ...
                        <p className="text-xs text-slate-400 mt-1">{pedido.etapa}</p>
                      </td>
                      <td className="px-6 py-4">
