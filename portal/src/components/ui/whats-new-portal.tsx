...
export function WhatsNewPortal({ forceOpen = false, onClose }: WhatsNewPortalProps) {
  ...
  return (
    <Modal
      ...
      description="Fique por dentro das últimas melhorias"
      size="md"
      tone="dark"
      mobileFullscreen
    >
      <div className="space-y-5">
          <div className="flex items-center gap-3 rounded-2xl border border-emerald-500/20 bg-gradient-to-br from-emerald-600/20 via-teal-600/10 to-transparent p-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-300">Mais agilidade para acompanhar e responder casos.</p>
            </div>
          </div>
